...
$template_parameters = array(
	...
	"item3"               => "green",        /* default (black) | red | blue | green | yellow | lilac */
	"item4"               => "yellow",       /* default (black) | red | blue | green | yellow | lilac */
	"item5"               => "lilac",        /* default (black) | red | blue | green | yellow | lilac */
	"item6"               => "default",      /* default (black) | red | blue | green | yellow | lilac */
	"item7"               => "default",      /* default (black) | red | blue | green | yellow | lilac */
	"item8"               => "default",      /* default (black) | red | blue | green | yellow | lilac */
